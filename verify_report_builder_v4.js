...
async function verify() {
    ...
    try {
        // 1. Login
        console.log("Logging in via /api/auth/login as admin@test.com...");
        const loginRes = await request(options('POST', '/auth/login'), { email: 'admin@test.com', password: 'admin' });
        ...
        console.log("Query Results Count:", query.length);
